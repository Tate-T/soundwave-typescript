...
const IsOpenBurger = (): void => setOpen(!isOpen);
console.log(isOpen);
  return (
    // <Container>
    <header>
      ...
      <button type="button" className={css.burger_button} onClick={IsOpenBurger}>
        <svg
          width="23.000000"
          height="10.166672"
          viewBox="0 0 23 10.1667"
          fill="none"
          xmlns="http://www.w3.org/2000/svg"
        >
          <defs />
