...
const Footer = () => {
  return (
    <footer className={css.footer}>
      ...
      <a className={css.footer_logo} href="#header">
        <svg
          className={css.footer__logo_svg}
          width="42"
          height="42"
          viewBox="0 0 42 42"
          fill="none"
      ...
      <div className={css.border_footer}/>
      ...
      <p className={css.copyright}>©2024, Soundwave. All rights reserved</p>
      </div >
    </footer>
  );
};
